...
function PaginationBar(props) {
    ...
    const handlePrevious = () => {
        if(currentPage > 0 && nested !== true) {
            setCurrentPage(currentPage - 1);
        }

        if(currentPage > 0 && nested === true) {
            setCurrentPage(accountId,currentPage - 1);
        }
    }

    const handleNext = () => {
        if(currentPage < totalPages - 1 && nested !== true) {
            setCurrentPage(currentPage + 1);
        }
    ...
    return (
        ...
        {
           (nested !== true) ?
           <div className="w-100 flex flex-row pl2 pr2 justify-between mv3
            pl3-l pr3-l
            ">
           ...
           <div className="w-100 flex flex-row pl2 pr2 justify-between mv3
            ...
            ">
                ...
                <div className="flex flex-row items-center">
                    ...
                    {
                        (totalPages === 1) ?
                        <div className={(currentPage === 0) ? classSelect : classNoSelect} onClick={() => setCurrentPage(accountId, 0)}>1</div>
                        : ""
                    }
                    {
                        (totalPages === 2) ?
                        <div className="flex flex-row">
                            <div className={(currentPage === 0) ? classSelect : classNoSelect} onClick={() => setCurrentPage(accountId, 0)}>1</div>
                            <div className={(currentPage === 1) ? classSelect : classNoSelect} onClick={() => setCurrentPage(accountId, 1)}>2</div>
                        </div>
                        : ""
                    }
                    {
                        ...
                        <div className="flex flex-row">
                            <div className={(currentPage === 0) ? classSelect : classNoSelect} onClick={() => setCurrentPage(accountId,0)}>1</div>
                            <div className={(currentPage === 1) ? classSelect : classNoSelect} onClick={() => setCurrentPage(accountId,1)}>2</div>
                            <div className={(currentPage === 2) ? classSelect : classNoSelect} onClick={() => setCurrentPage(accountId,2)}>3</div>
                        </div>
                        : ""
                    }
                    {
                        ...
                        <div className="flex flex-row">
                            ...
                            <div className={(currentPage === 1) ? classSelect : classNoSelect} onClick={() => setCurrentPage(accountId,1)}>2</div>
                            <div className={(currentPage === 2) ? classSelect : classNoSelect} onClick={() => setCurrentPage(accountId,2)}>3</div>
                            <div className={(currentPage === 3) ? classSelect : classNoSelect} onClick={() => setCurrentPage(accountId,3)}>4</div>
                        </div>
                        : ""
                    }
                    {
                        ...
                        <div className="flex flex-row">
                            ...
                            <div className={(currentPage === 2) ? classSelect : classNoSelect} onClick={() => setCurrentPage(accountId,2)}>3</div>
                            <div className={(currentPage === 3) ? classSelect : classNoSelect} onClick={() => setCurrentPage(accountId,3)}>4</div>
                            <div className={(currentPage === 4) ? classSelect : classNoSelect} onClick={() => setCurrentPage(accountId,4)}>5</div>
                        </div>
                        : ""
                    }
                    {
                        ...
                        <div>
                            {
                                ...
                                <div className="flex flex-row">
                                    ...
                                    <div className={(currentPage === 2) ? classSelect : classNoSelect}  onClick={() => setCurrentPage(accountId,2)}>3</div>
                                    <div className={(currentPage === 3) ? classSelect : classNoSelect}  onClick={() => setCurrentPage(accountId,3)}>4</div>
                                    <div className={(currentPage === totalPages - 1) ? classSelect : classNoSelect}  onClick={() => setCurrentPage(accountId,totalPages - 1)}>{totalPages}</div>
                                </div>
                                : ""
                            }
                            {
                                ...
                                <div className="flex flex-row">
                                    <div className={(currentPage === 0) ? classSelect : classNoSelect} onClick={() => setCurrentPage(accountId,0)}>1</div>
                                    <div className={(currentPage === currentPage - 1) ? classSelect : classNoSelect} onClick={() => setCurrentPage(accountId,currentPage - 1)}>{currentPage}</div>
                                    <div className={(currentPage === currentPage) ? classSelect : classNoSelect} onClick={() => setCurrentPage(accountId,currentPage)}>{currentPage + 1}</div>
                                    <div className={(currentPage === currentPage + 1) ? classSelect : classNoSelect} onClick={() => setCurrentPage(accountId,currentPage + 1)}>{currentPage + 2}</div>
                                    <div className={(currentPage === totalPages - 1) ? classSelect : classNoSelect} onClick={() => setCurrentPage(accountId,totalPages - 1)}>{totalPages}</div>
                                </div>
                                : ""
                            }
                            {
                                ...
                                <div className="flex flex-row">
                                    <div className={(currentPage === 0) ? classSelect : classNoSelect} onClick={() => setCurrentPage(0)}>1</div>
                                    <div className={(currentPage === totalPages - 3) ? classSelect : classNoSelect} onClick={() => setCurrentPage(accountId,totalPages - 3)}>{totalPages - 2}</div>
                                    <div className={(currentPage === totalPages -2 ) ? classSelect : classNoSelect} onClick={() => setCurrentPage(accountId,totalPages - 2)}>{totalPages -1 }</div>
                                    <div className={(currentPage === totalPages -1) ? classSelect : classNoSelect} onClick={() => setCurrentPage(accountId,totalPages - 1)}>{totalPages}</div>
                                </div>
                                : ""
                            }
